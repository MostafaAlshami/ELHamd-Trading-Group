...
class Storages extends Model {
	...
	function fillArray() {
		...
		while ($row = $result->fetch_assoc()) {
			array_push($this->storages, new Storage($row["ID"], $row["quantity"], $row["product_id"]));
		}
	}
	...
	function insertStorage ($SID, $product_id, $quantity){
		$sql = "INSERT INTO storage (ID, product_id, quantity) VALUES ('$SID','$product_id', '$quantity')";
